const Info: React.FC = () => {
  return (
    <div className="py-5 space-y-7 relative">
      <h1 className="xl:text-[55px] lg:text-[45px] md:text-[40px] text-[36px] font-[600] lg:w-5/6 lg:mx-auto ">
      ...
      <img
        ...
        alt=""
        className="absolute max-w-[250px] xl:top-[65px] lg:top-[50px] xl:left-[8rem] lg:left-[6rem] md:top-[50px] md:left-[1rem] lg:w-[250px] md:w-[200px] left-[1rem] top-[45px] w-[190px]"
      />

      <p className="lg:text-lg pb-5 lg:w-5/6 mx-auto leading-loose">
        I'm a passionate{" "}
